class Game {
  ...
  handleElements() {
    ...
    this.resetTitle.positon(width/2+200,100);
    this.resetTitle.class("resetText");

    this.leaderBoardTitle.html("Leader Board");
    this.leaderBoardTitle.position(width/2-200,100);
    this.leaderBoardTitle.class("leadersText");

    this.leader1.position(width/2-200,150);
    this.leader1.class("leadersText");

    this.leader2.position(width/2-200,200);
